...
import { LayoutDashboard, Bot, Stethoscope, ClipboardList, Pill, UserCircle, LogOut, ChevronLeft, ChevronRight } from "lucide-react";
...
export function Sidebar({ onNavigate }: SidebarProps) {
  ...
  const navItems = [
    ...
    { path: "/chat", icon: Bot, label: t.chat },
    { path: "/predict", icon: Stethoscope, label: t.predictor },
    { path: "/records", icon: ClipboardList, label: t.records },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 p-4 border-b border-sidebar-border">
        ...
        {!collapsed && (
          <span className="text-lg font-bold tracking-tight">DVDS-Health</span>
        )}
      </div>
