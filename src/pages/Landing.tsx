            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                <Button
                  onClick={handleSignIn}
                  size="lg"
                  className="gradient-accent border-0 text-white hover:opacity-90 text-base md:text-lg px-6 md:px-8 py-5 md:py-6 shadow-xl shadow-accent/30"
                >
                  Get Started Free
              ...
              <Link to="/about">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-white/40 bg-white/10 text-white hover:bg-white/20 hover:border-white/60 text-base md:text-lg px-6 md:px-8 py-5 md:py-6 w-full sm:w-auto backdrop-blur-sm"
                  >
                    Learn More
                  </Button>
                </motion.div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-transparent to-black/10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Zap, title: "Real-Time Sync", desc: "Your health data syncs instantly across all devices" },
              { icon: Clock, title: "24/7 AI Support", desc: "Get health guidance anytime with our AI bot" },
              { icon: TrendingUp, title: "Track Progress", desc: "Visual insights into your health journey" },
            ].map((item, index) => (
              <motion.div
                key={item.title}
                initial={{ opacity: 0, y: 20 }}
