        ...
        >
          <Card className="bg-white/10 backdrop-blur-sm border-white/10 text-white mb-6">
            ...
            <CardContent className="space-y-4 text-white/80">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>Chat History:</strong> Conversations with DVDL Bot for continuity of care discussions</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/10 text-white mb-6">
            ...
            <CardContent className="space-y-4 text-white/80">
              ...
              <p className="mt-4">
                To exercise these rights, contact us at privacy@dvdl-health.com
              </p>
            </CardContent>
          </Card>
        </motion.div>
